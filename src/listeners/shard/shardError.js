	...
	async run(e) {
		...
		this.client.shard.fetchClientValues('guilds.cache.size').then(guilds => {
            ...
            const embed = new Discord.MessageEmbed()
                ...
                .setDescription('Musicj_DJ Shards Error.')
                .addField('Error', `[Shard ${i}] Error ${e}...`, true)
                .setFooter(`${totalGuilds} guilds`)
                .setTimestamp();
            this.client.shardMessage(this.client, this.client.channelList.errorChannel, embed);
